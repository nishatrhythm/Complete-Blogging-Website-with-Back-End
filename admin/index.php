                    ...
                    <tbody>
                        <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
                            ...
                            <tr>
                                ...
                                <td align="center"><a href="<?= ROOT_URL ?>admin/edit-post.php?id=<?= $post['id'] ?>" class="btn sm">Edit</a></td>
                                <td align="center"><a href="<?= ROOT_URL ?>admin/delete-post.php?id=<?= $post['id'] ?>" class="btn sm danger">Delete</a></td>
                            </tr>
                        <?php endwhile ?>
                    </tbody>
                </table>
